...
namespace WpfMvvm.MVVM
{
    ...
    public static partial class SafeFireAndForgetExtensions
    {
        ...
        public static void SafeFireAndForget(this ValueTask task, in bool continueOnCapturedContext, in Action<Exception> onException) => task.SafeFireAndForget(in onException, in continueOnCapturedContext);
        ...
        public static void SafeFireAndForget<TException>(this ValueTask task, in bool continueOnCapturedContext, in Action<TException> onException) where TException : Exception => task.SafeFireAndForget(in onException, in continueOnCapturedContext);
        ...
        /// <param name="onException">If an exception is thrown in the Task, <c>onException</c> will execute. If onException is null, the exception will be re-thrown</param>
        [Obsolete("Use SafeFireAndForget(Action<Exception> onException, bool continueOnCapturedContext)")]
        public static void SafeFireAndForget(this Task task, in bool continueOnCapturedContext, in Action<Exception> onException) => task.SafeFireAndForget(in onException, in continueOnCapturedContext);
        ...
        /// <typeparam name="TException">Exception type. If an exception is thrown of a different type, it will not be handled</typeparam>
        [Obsolete("Use SafeFireAndForget<TException>(Action<TException> onException, bool continueOnCapturedContext)")]
        public static void SafeFireAndForget<TException>(this Task task, in bool continueOnCapturedContext, in Action<TException> onException) where TException : Exception => task.SafeFireAndForget(in onException, in continueOnCapturedContext);
        #endregion
    }
}
